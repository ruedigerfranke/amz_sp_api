...
SwaggerClient - the Ruby gem for the Selling Partner API for Retail Procurement Orders
...
------------ | ------------- | ------------- | -------------
*SwaggerClient::VendorOrdersApi* | [**get_purchase_order**](docs/VendorOrdersApi.md#get_purchase_order) | **GET** /vendor/orders/v1/purchaseOrders/{purchaseOrderNumber} | 
*SwaggerClient::VendorOrdersApi* | [**get_purchase_orders**](docs/VendorOrdersApi.md#get_purchase_orders) | **GET** /vendor/orders/v1/purchaseOrders | 
*SwaggerClient::VendorOrdersApi* | [**get_purchase_orders_status**](docs/VendorOrdersApi.md#get_purchase_orders_status) | **GET** /vendor/orders/v1/purchaseOrdersStatus | 
*SwaggerClient::VendorOrdersApi* | [**submit_acknowledgement**](docs/VendorOrdersApi.md#submit_acknowledgement) | **POST** /vendor/orders/v1/acknowledgements | 

## Documentation for Models

 - [SwaggerClient::AcknowledgementStatusDetails](docs/AcknowledgementStatusDetails.md)
 - [SwaggerClient::Address](docs/Address.md)
 - [SwaggerClient::DateTimeInterval](docs/DateTimeInterval.md)
 - [SwaggerClient::Decimal](docs/Decimal.md)
 - [SwaggerClient::Error](docs/Error.md)
 - [SwaggerClient::ErrorList](docs/ErrorList.md)
 - [SwaggerClient::GetPurchaseOrderResponse](docs/GetPurchaseOrderResponse.md)
 - [SwaggerClient::GetPurchaseOrdersResponse](docs/GetPurchaseOrdersResponse.md)
 - [SwaggerClient::GetPurchaseOrdersStatusResponse](docs/GetPurchaseOrdersStatusResponse.md)
 - [SwaggerClient::ImportDetails](docs/ImportDetails.md)
 - [SwaggerClient::ItemQuantity](docs/ItemQuantity.md)
 - [SwaggerClient::ItemStatus](docs/ItemStatus.md)
 - [SwaggerClient::Money](docs/Money.md)
 - [SwaggerClient::Order](docs/Order.md)
 - [SwaggerClient::OrderAcknowledgement](docs/OrderAcknowledgement.md)
 - [SwaggerClient::OrderAcknowledgementItem](docs/OrderAcknowledgementItem.md)
 - [SwaggerClient::OrderDetails](docs/OrderDetails.md)
 - [SwaggerClient::OrderItem](docs/OrderItem.md)
 - [SwaggerClient::OrderItemAcknowledgement](docs/OrderItemAcknowledgement.md)
 - [SwaggerClient::OrderItemStatus](docs/OrderItemStatus.md)
 - [SwaggerClient::OrderItemStatusAcknowledgementStatus](docs/OrderItemStatusAcknowledgementStatus.md)
 - [SwaggerClient::OrderItemStatusOrderedQuantity](docs/OrderItemStatusOrderedQuantity.md)
 - [SwaggerClient::OrderItemStatusReceivingStatus](docs/OrderItemStatusReceivingStatus.md)
 - [SwaggerClient::OrderList](docs/OrderList.md)
 - [SwaggerClient::OrderListStatus](docs/OrderListStatus.md)
 - [SwaggerClient::OrderStatus](docs/OrderStatus.md)
 - [SwaggerClient::OrderedQuantityDetails](docs/OrderedQuantityDetails.md)
 - [SwaggerClient::Pagination](docs/Pagination.md)
 - [SwaggerClient::PartyIdentification](docs/PartyIdentification.md)
 - [SwaggerClient::SubmitAcknowledgementRequest](docs/SubmitAcknowledgementRequest.md)
 - [SwaggerClient::SubmitAcknowledgementResponse](docs/SubmitAcknowledgementResponse.md)
