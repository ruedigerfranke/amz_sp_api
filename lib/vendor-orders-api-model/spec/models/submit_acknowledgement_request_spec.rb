...
# Unit tests for SwaggerClient::SubmitAcknowledgementRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubmitAcknowledgementRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::SubmitAcknowledgementRequest.new
  end
  ...
  describe 'test an instance of SubmitAcknowledgementRequest' do
    it 'should create an instance of SubmitAcknowledgementRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::SubmitAcknowledgementRequest)
    end
  end
