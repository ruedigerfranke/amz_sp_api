...
# Unit tests for SwaggerClient::OrderItemAcknowledgement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemAcknowledgement' do
  before do
    # run before each test
    @instance = SwaggerClient::OrderItemAcknowledgement.new
  end
  ...
  describe 'test an instance of OrderItemAcknowledgement' do
    it 'should create an instance of OrderItemAcknowledgement' do
      expect(@instance).to be_instance_of(SwaggerClient::OrderItemAcknowledgement)
    end
  end
