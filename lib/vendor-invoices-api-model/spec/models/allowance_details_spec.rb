...
# Unit tests for SwaggerClient::AllowanceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllowanceDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::AllowanceDetails.new
  end
  ...
  describe 'test an instance of AllowanceDetails' do
    it 'should create an instance of AllowanceDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::AllowanceDetails)
    end
  end
